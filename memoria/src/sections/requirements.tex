...
\begin{itemize}
	\item \textbf{Gestión de usuarios (GU):} Registro, autenticación y administración de las cuentas de acceso al sistema.
	\item \textbf{Introducción de recetas (IR):} Alta manual o automática de recetas y su posterior clasificación, búsqueda y mantenimiento.
	\item \textbf{Planificación de menús (PM):} Elaboración de menús a partir de las recetas disponibles y su mantenimiento.
	\item \textbf{Consulta de valores nutricionales (VN):} Cálculo de la aportación nutricional de recetas y periodos, y seguimiento de los objetivos fijados.
	\item \textbf{Gestión de listas de la compra (LC):} Obtención de las listas de la compra derivadas de los menús y control de su cumplimiento.
\end{itemize}
...
\req[
	identificador=RNF-DE-05,
	titulo={Dominio},
	descripcion={El proyecto se servirá a través de un dominio personalizado, facilitando el acceso a él desde cualquier dispositivo con acceso a internet.},
	prioridad={Should Have}
]
...
\req[
	identificador=RNF-SE-05,
	titulo={Acceso restringido al entorno de desarrollo},
	descripcion={El entorno de desarrollo no será accesible públicamente, sino únicamente por el equipo de desarrollo.},
	prioridad={Should Have}
]

\req[
	identificador=RNF-SE-06,
	titulo={Acceso restringido a la API desde dominios externos},
	descripcion={La API sólo admitirá peticiones desde el front-end de su propio entorno.},
	prioridad={Must Have}
]
