...
\begin{itemize}
	...
	\item \textbf{FatSecret} (\url{https://www.fatsecret.es/})\\
	      Combina el conteo de calorías y macronutrientes con una base de datos que supera los 1,9 millones de alimentos verificados, accesible mediante un buscador que ofrece la información nutricional de cada referencia. Añade recetario, seguimiento de la actividad física, planes de comidas y recursos educativos, así como una comunidad de usuarios con la que compartir el progreso. Está dirigida a un público generalista interesado en el control de su dieta, con un registro gratuito como vía principal de acceso.
