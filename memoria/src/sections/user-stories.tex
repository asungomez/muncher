...
\us[
  ...
  criterios={
    \begin{itemize}
      ...
      \item El pre-commit hook falla si ha tenido que hacer alteraciones en algún archivo.
  ...
  tareas={
    \begin{itemize}
      ...
      \item Asegurarse de que el pre-commit hook falla si ha tenido que hacer alteraciones en algún archivo.
