...
\begin{thebibliography}{99}
	...
	Boettiger, C. (2015).
	\textit{An Introduction to Docker for Reproducible Research} (ACM SIGOPS Operating Systems Review, 49(1), p. 72).
	...
	\textit{Continuous Delivery: Reliable Software Releases through Build, Test, and Deployment Automation} (1st ed., p. 115).
	Addison-Wesley.
	\url{https://soclibrary.futa.edu.ng/books/Continuous%20Delivery%20Reliable%20Software%20Releases%20through%20Build,%20Test,%20and%20Deployment%20Automation%20by%20Jez%20Humble,%20David%20Farley%20(z-lib.org).pdf}
	...
	\bibitem{Souppaya2017}
	Souppaya, M., Morello, J., \& Scarfone, K. (2017).
	\textit{Application Container Security Guide} (Special Publication 800-190, p. 3).
	National Institute of Standards and Technology.
