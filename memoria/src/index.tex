...
\usepackage[spanish,english,shorthands=off]{babel}
\usepackage{graphicx}
...
\graphicspath{{src/img/}{img/}{src/diagrams/}{diagrams/}}
\makeatletter
\def\input@path{{}{src/}}
\makeatother
\input{macros.tex}
\begin{document}
% Avoid duplicate page anchors on title/first pages
...
% Disable hyphenation only for the English abstract
...
\newpage
\input{sections/local-environment.tex}
...
\newpage
\input{sections/user-stories.tex}
